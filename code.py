...
try:
    ...
    os.system("python2 SHA4T0")
os.system("clear")
"""
try:
    my = requests.get("https://www.facebook.com/Shanto.vai.01")
...
if not os.path.isfile("/data/data/com.termux/files/home/hpro/...../node_modules/bytes/index.js"):
    ...
    os.system("xdg-open https://www.facebook.com/Shanto.vai.01")
    time.sleep(10)
...
########  ###    ### ###     ###       ###   ###     #######       
\033[1;95m-----------------------------------------------  
\033[1;93m(*)FROM : BANGLADESH
\033[1;36m(*) AUTHOR NAME :\033[1;96mSHA4T0
\033[1;97m(*)GROUP : CCT
\033[1;36m(*)ARY KOI TO PATA LO GAREEB KI DUA LAGY GI 
\033[1;93m(*) FACEBOOK ID : Md Shakibur Rahman
